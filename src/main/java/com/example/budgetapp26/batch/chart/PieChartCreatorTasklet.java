...
public class PieChartCreatorTasklet implements Tasklet {
    ...
    private PieDataset createDataset() {
        ...
        // Add dataset values
        for (Transaction transaction : transactionRepo.findByTheValueLessThan(Double.parseDouble("0.0"))) {
            ...
            try {
                double value = -transaction.getTheValue() + dataset.getValue(txnCategory.toString()).doubleValue();
                ...
                // first time here
                double value = -transaction.getTheValue();
